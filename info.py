...
API_ID = int(environ.get('API_ID','23080322'))
API_HASH = environ.get('API_HASH','b3611c291bf82d917637d61e4a136535')
BOT_TOKEN = environ.get('BOT_TOKEN','7244798355:AAHZLic8q0cy1_AnYhHyxjzXGoz9K_CxBks')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7011929837').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002163652547').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL','-1002163652547')
auth_grp = environ.get('AUTH_GROUP','-1002150515664')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID','-1002150515664')
...
# MongoDB information
SECONDDB_URI = environ.get('SECONDDB_URI', 'mongodb+srv://chaunisha765:wjBlF8fJdH3A3Psa@cluster0.gzvhkn8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0')
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://chaunisha765:lXSt6OXgWJYfNm3i@cluster0.gdtpfke.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002163652547'))
